...
export default function Page() {
  return (
    <div className="min-h-screen bg-[#F9F7F2] text-[#1A1A1B] font-serif selection:bg-[#004B50] selection:text-white">
      ...
      {/* Hero */}
      <section data-anim="hero-section" className="max-w-5xl mx-auto px-6 py-20 text-center">
        <h1 data-anim="hero-headline" className="text-5xl font-bold mb-6">Status Q Copy</h1>
        <p data-anim="hero-subtitle" className="text-xl font-sans text-gray-600 mb-10">High-Converting Scripts & Tech Strategy for Real Estate Professionals.</p>
        <div data-anim="accent-line" className="h-1 w-20 bg-[#004B50] mx-auto mb-10"></div>
      </section>

      {/* Services for Stripe Compliance */}
      <section data-anim="section-fade" className="max-w-4xl mx-auto px-6 py-10 font-sans">
        <h2 className="text-2xl font-serif font-bold mb-8 text-[#004B50]">Our Services</h2>
        <div className="grid md:grid-cols-2 gap-10">
          <div data-anim="service-card" className="border-b border-gray-200 pb-6">
      ...
      <section data-anim="section-fade" className="max-w-4xl mx-auto px-6 py-20 text-center font-sans">
      ...
      <footer data-anim="section-fade" className="max-w-5xl mx-auto px-6 py-10 border-t border-gray-200 font-sans text-xs text-gray-400 flex justify-between">
